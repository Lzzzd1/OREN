...
from src.models import Users, Telefone, Cliente, Venda, Origem, Produto, Campanha, CanalDaVenda, db
...
admin.add_view(MyView(Produto, db.session, 'Produto'))
admin.add_view(MyView(CanalDaVenda, db.session, 'Canal'))
